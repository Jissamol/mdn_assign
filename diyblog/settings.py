...
SECRET_KEY = 'django-insecure-9wqz=-@yz9hx=j5^+!@pe@rck8xp%pc2d==44w33rc3xal+xs3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['mdn-assign-5.onrender.com', 'localhost', '127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates', BASE_DIR / 'blog/templates'],  # Add both template directories
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_URL = '/blog/templates/blog/login/'  # Login page URL
